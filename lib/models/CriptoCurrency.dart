...
class CriptoCurrencyModel {
  ...
  final List<CriptoCurrency> dataModel;

  CriptoCurrencyModel({
    required this.statusModel,
    required this.dataModel,
  });
  factory CriptoCurrencyModel.fromJson(Map<String, dynamic> json) {
    var dataList = json['data'] as List;
    List<CriptoCurrency> dataModelList =
        dataList.map((e) => CriptoCurrency.fromJson(e)).toList();
    return CriptoCurrencyModel(
      statusModel: StatusModel.fromJson(json["status"]),
      dataModel: dataModelList,
    );
  }
  CriptoCurrencyModel.withError(String error)
...
class CriptoCurrency {
  ...
  CriptoCurrency(
      ...
      this.lastUpdated,
      this.quoteModel);
  factory CriptoCurrency.fromJson(Map<String, dynamic> json) {
...
class UsdModel {
  ...
  factory UsdModel.fromJson(Map<String, dynamic> json) {
    return UsdModel(
        ...
        percentChange_24h: json["percent_change_24h"] == null
            ? 0.0
            : json["percent_change_24h"],
        percentChange_7d:
            json["percent_change_7d"] == null ? 0.0 : json["percent_change_7d"],
        percentChange_30d: json["percent_change_30d"] == null
            ? 0.0
